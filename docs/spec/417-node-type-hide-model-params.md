...
> 상태: **완료** · 2026-07-20 · 발단: 개발자 "노드형 에이전트 수정에서 세부 탭에서 모델 메타값
> 설정은 이상하다. 노드마다 셋팅했으니까." 방향=숨김(개발자 선택). tsc0·브라우저 SHOT417_OK.
...
"모든 노드 공통 기본값"으로 작동은 한다. 하지만 모델 선택 없이 노출돼 혼란(개발자 지적). 직접·조율·
