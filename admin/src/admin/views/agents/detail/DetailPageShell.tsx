/* 상세 페이지 공용 셸(스펙 246 후속5 — 사용자 지적 "소스별 상세 컴포넌트 차이가 크다").
   ...
   ui/code/external 셋이 같은 뼈대(상단 Tabs+활성 탭만 렌더+개요 지도)를 쓴다.
   내용이 적어도 탭 구조는 유지(구조 일관성 > 밀도 최적화 — 사용자 결정).
   후속6(사용자): 좌측 세로 네비 → **상단 antd Tabs** — 다른 화면들과 같은 탭 문법(admin/CLAUDE.md:
   데이터 집합 전환=Tabs). 모바일은 Tabs 기본 가로 스크롤. */
import { useState } from 'react'
import { Avatar, Button, Tooltip, message, Tabs } from 'antd'
