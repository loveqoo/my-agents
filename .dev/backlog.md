...
- [ ] **suite 2건 복구 — 8045 API key(2026-07-19 실측)**: dev 기본 chat(qwen3.6-35b@localhost:8045)이 API key를 요구하게 바뀌어 pipeline-override-temperature·pipeline-memory-recall 실패(49/51). provider에 키 설정 또는 기본 모델 mock 복귀 — **dev 환경 결정이라 구남님 지시 필요**(1분 작업).
