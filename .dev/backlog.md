...
- ✅**평가 하네스 제품화 1탄=스펙 137 완료**(2026-07-03) — 문제집 DB·오염제로 러너·평가 메뉴. ✅2탄(추이+비교)=스펙 138 완료(2026-07-03). ✅3탄(LLM-judge)=스펙 139 완료(2026-07-03). 남은 후속: **RAG 평가 러너**(kind='rag' — 사용자 요청, 다음 차례), 심판 모델 선택 UI·다중 심판 합의(씨앗).
