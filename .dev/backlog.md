...
- [후보] 285 기본 public + 생성자 축 분리 — 284에서 분리(2026-07-10): 현 모델 공개=owner_id 소멸이라 "기본 public+내 것 tint" 양립 불가. created_by 신설(마이그레이션)+147 가시성 게이트(404-fold·복제·A2A·메모리) 재설계. RBAC 체크리스트+codex 적대 필수.
