...
- ✅**모델별 비교+격자=스펙 141 완료**(2026-07-03, 조사 learning 141 기반). 다음: **골든셋 자동 생성(스펙 142, 진행 예정)** → 이후 씨앗: 프롬프트 축 격자·judge 신뢰성(심판 벤치마크)·expected 1급 필드·RAG 표준 메트릭(faithfulness류)·인간 리뷰 층·세션→케이스 수확.
