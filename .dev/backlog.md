...
- [ ] **RAG 인제스트 후속 씨앗**(스펙 334·335 OUT, 2026-07-14): ~~실패 문서 재시도 버튼~~·~~진행률~~ **→ 스펙 435 완료**(2026-07-31, 회고 358: 보존 blob 재인제스트+휘발 진행률 맵, verify 10/10+브라우저 3/3). **잔여**: 이벤트 버스에 재인덱싱·평가 런 합류(각 publish 한 줄) · 영속 알림함(놓친 이벤트 재생).
