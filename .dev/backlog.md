...
- **평가 하네스 제품화**(방향 3 OUT) — DB 데이터셋·API·어드민 UI + LLM-judge 스코어러(비결정 축).
...
- **플레이그라운드 모바일 컴팩트 헤더**(스펙 132, 점검 2탄) — AgentCombo/SessionCombo iconOnly(모바일)+
  드롭다운 뷰포트 캡. 뷰포트 페어 검증 7/7. 완료(2026-07-03, 회고 113). 미푸시.
